...
class EDIT(Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.add_path_button = Button(self.canvas,
            text="Add Path",
        ...
        self.button_2 = Button(self.canvas,
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: self.parent.handle_btn_press(self.parent.mis_btn,"mis"),
        ...
        self.drone_names = ["MCU", "CD1", "CD2", "CD3", "CD4", "CD5"]  # Add your drone names here
        ...
        self.drone_menu.place(x=24.0, y=122.0, width=80.0, height=23.0)
        ...
        self.extra_cmd_entry = Entry(self.canvas,
            ...
            highlightbackground="#123423",  # Set the highlight border color to white
            highlightcolor="#00FFFF"  # Set the highlight color to white
        )
        ...
        self.mission_name_entry = Entry(
            self.canvas,
            bd=0,
            bg="#1D1C1D",
            fg="#ffffff",
            highlightthickness=1,  # Set highlight thickness to 1
            highlightbackground="#FFFFFF",  # Set the highlight border color to white
            highlightcolor="#FFFFFF"  # Set the highlight color to white
        )
        ...
        self.run_mission_button = Button(
            self.canvas,
            text="RUN MISSION!",
            command=lambda: self.run_mission(),
            bg="#2A282C",
            fg="#FFFFFF",
            relief="flat",
            activebackground="#2A282C"
        )
        self.run_mission_button.place(
            x=124.0,
            y=663.0,
            width=150.0,
            height=30.0
    ...
    def run_mission(self):
        ...
        send(MCU_host,f"run_mis('{mission_name}')")
    ...
    def add_path(self):
        ...
        if extra_cmd and drone_name:
            ...
            elif extra_cmd.startswith("-"):
                path_info = f"{extra_cmd[1:]}"
            else:
